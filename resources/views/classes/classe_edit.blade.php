            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center ">
                        <div class="col-md-8">
                            <div class="page-title-box">
                                <h4 class="page-title">Update Classe</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Home / Classes / Update Classe</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <p class="sub-title">Update Information classes</p>
                                    <form action="{{url('update/classe')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                      <input type="hidden" name="id" value="{{ $classe->id }}">    
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                            <div class="col-sm-10">
                                                <input class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $classe->name }}" type="text" id="name" placeholder="Enter name">
                                                @error('name')
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <select class="form-control @error('academic_level_id') is-invalid @enderror" name="academic_level_id" id="academic_level_id" placeholder="Select academic_level">
            ...
            <option value="{{$atem->id}}" {{$classe->academic_level_id== $atem->id ?'selected':''}}>{{$atem->name}}</option>
            @endforeach
        </select>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <select class="form-control @error('school_id') is-invalid @enderror"  name="school_id" id="school_id" placeholder="Select school">
            ...
            <option value="{{$school->id}}"  {{$classe->school_id== $school->id ?'selected':''}}>{{$school->name}}</option>
            @endforeach
        </select>
        @error('school_id')
            <span class="invalid-feedback" role="alert">
