                    ...
                    <div class="row align-items-center ">
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Home / Exercises / Add Exercise</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <p class="sub-title">Add Information Exercises</p>
                                    <form action="{{route('save/newexercise')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
