                    ...
                    <div class="row align-items-center ">
                        <div class="col-md-8">
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Home / Story/ Edit Story</li>
                                </ol>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <p class="sub-title">Edit Information Story</p>
                                    <form action="{{ url('update-story/'.$stories->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                            <div class="col-sm-10">
                                                <input class="form-control @error('name') is-invalid @enderror" name="name" value="{{$stories->name}}" type="text" id="name" placeholder="Enter name">
                                                @error('name')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('description') is-invalid @enderror" name="description" value="{{$stories->description}}" type="textarea" id="description" placeholder="Enter description">
                                                @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('path') is-invalid @enderror" value="{{$stories->path}}" type="file" name="path" id="path" multiple="">
                                                @error('path')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                            <img src="{{asset('file_storage/'. $stories->picture) }}" width="70px" alt="image">
                                        ...
                                        <div class="form-group row  mt-100">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control @error('type_id') is-invalid @enderror"  name="type_id[]" id="types" placeholder="Select type" multiple>
                                                    ...
                                                    <option value="{{$item->id}}" {{$stories->types()->pluck('type_id')->contains($item->id)?'selected':''}}>{{$item->name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('type_id')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group row ">
                                            <label for="example-email-input" class="col-sm-2 col-form-label">academic level</label>
                                            <div class="col-sm-10">
                                                <select class="form-control @error('academic_level_id') is-invalid @enderror"  name="academic_level_id[]" id="academics" placeholder="Select academic level" multiple>
                                                    <option value="">Select Type</option>
                                                    
                                                    
                                                    @foreach($academic_levels as $item)
                                                        <option value="{{$item->id}}" {{$stories->academic_levels()->pluck('academic_level_id')->contains($item->id)?'selected':''}}>{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control @error('difficulty_level_id') is-invalid @enderror" name="difficulty_level_id" id="difficultyl" placeholder="Select difficulty_level">
                                                    ...
                                                    <option value="{{$atem->id}}"  {{$stories->difficulty_level->id== $atem->id ?'selected':''}}> {{$atem->name}}</option>
                                                    @endforeach
                                                </select>
