...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route('all/student/list')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<div class="card shadow mb-4">
    ...
    <form method="POST" action="{{route('upload')}}" enctype="multipart/form-data">
        ...
        <div class="card-footer">
            ...
            <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('all/student/list') }}">Cancel</a>
        </div>
    </form>
</div>
